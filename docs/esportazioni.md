...
Il modulo **Esportazioni** di Meridiana 1.3.0 permette di estrarre massivamente i dati dal database catastale per poterli consultare offline, stamparli o rielaborarli in altri software (come Microsoft Excel).
...
Meridiana 1.3.0 supporta tre formati di esportazione professionali:
